...
contract ERC20 is IERC20{
    ...
    function transferFrom(address sender, address recipient, uint amount) override external enoughTokens(sender, amount) {
...
contract RKUToken is ERC20 {
    constructor(address shop) ERC20("RKUToken", "RKU", 20, shop) {}
}
...
contract RShop {
    ...
    constructor() {
        token = new RKUToken(address(this));
