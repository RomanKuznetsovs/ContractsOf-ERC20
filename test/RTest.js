...
const tokenJSON = require("../artifacts/contracts/ERC20.sol/RKUToken.json")

describe('RShop', function() {
    let owner
    let buyer
    let shop
    let erc20
    ...
    beforeEach(async function() {
        ...
        const RShop = await ethers.getContractFactory("RShop", owner)
        shop = await RShop.deploy()
        await shop.deployed()
